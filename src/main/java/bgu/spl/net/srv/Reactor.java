...
public class Reactor<T> implements Server<T> {
    ...
    private BGUConnections connections;
    ...
    public Reactor(
            ...
            Supplier<MessageEncoderDecoder<T>> readerFactory, BGUConnections connections) {
            ...
            while (!Thread.currentThread().isInterrupted()) {
                ...
                for (SelectionKey key : selector.selectedKeys()) {
                    ...
                    if (!key.isValid()) {
                        ...
                        handleAccept(serverSock, selector , bguConnections);
                    } else {
                        handleReadWrite(key);
                    }
                }
    ...
    private void handleAccept(ServerSocketChannel serverChan, Selector selector, BGUConnections connections) throws IOException {
